...
import DropdownNotifications from './navbar/DropdownNotifications.jsx';
import DropdownUser from './navbar/DropdownUser.jsx';
import Logo from '../assets/svg/logos/logo.svg'
import LogoLight from '../assets/svg/logos-light/logo.svg'
                ...
                <div className="card-header card-header-content-between">
                  ...
                  <div className="dropdown">
                    ...
                    >
                      ...
                      <a className="dropdown-item" href="#">
                        <i className="bi-check2-all dropdown-item-icon" /> Mark
                        all as read
                      </a>
                      <a className="dropdown-item" href="#">
                        <i className="bi-toggle-off dropdown-item-icon" />{" "}
                            ...
                            <div className="col-auto">
                              <div className="d-flex align-items-center">
                                ...
                                <div className="avatar avatar-sm avatar-circle">
                                  <img
                                    className="avatar-img"
                                    src="src/assets/svg/brands/google-icon.svg"
                                    alt="Image Description"
                                  />
                                </div>
                              </div>
                            ...
                            <div className="col-auto">
                              <div className="d-flex align-items-center">
                                ...
                                <div className="avatar avatar-sm avatar-circle">
                                  <img
                                    className="avatar-img"
                                    src="src/assets/img/160x160/img7.jpg"
                                    alt="Image Description"
                                  />
                                </div>
                              </div>
                            ...
                            <div className="col-auto">
                              <div className="d-flex align-items-center">
                                ...
                                <div className="avatar avatar-sm avatar-circle">
                                  <img
                                    className="avatar-img"
                                    src="src/assets/img/160x160/img8.jpg"
                                    alt="Image Description"
                                  />
                                </div>
                              </div>
                    ...
                    <div className="d-flex align-items-center">
                      <div className="flex-shrink-0">
                        <img
                          ...
                          src="src/assets/svg/brands/atlassian-icon.svg"
                          alt="Image Description"
                        />
                      </div>
                  ...
                  <a className="dropdown-item" href="#">
                    <div className="d-flex align-items-center">
                      <div className="flex-shrink-0">
                        <img
                          className="avatar avatar-xs avatar-4x3"
                          src="src/assets/svg/brands/slack-icon.svg"
                          alt="Image Description"
                        />
                      </div>
                      <div className="flex-grow-1 text-truncate ms-3">
                  ...
                  <a className="dropdown-item" href="#">
                    <div className="d-flex align-items-center">
                      <div className="flex-shrink-0">
                        <img
                          className="avatar avatar-xs avatar-4x3"
                          src="src/assets/svg/brands/google-webdev-icon.svg"
                          alt="Image Description"
                        />
                      </div>
                      <div className="flex-grow-1 text-truncate ms-3">
                  ...
                  <a className="dropdown-item" href="#">
                    <div className="d-flex align-items-center">
                      <div className="flex-shrink-0">
                        <img
                          className="avatar avatar-xs avatar-4x3"
                          src="src/assets/svg/brands/frontapp-icon.svg"
                          alt="Image Description"
                        />
                      </div>
                      <div className="flex-grow-1 text-truncate ms-3">
                  ...
                  <a className="dropdown-item" href="#">
                    <div className="d-flex align-items-center">
                      <div className="flex-shrink-0">
                        <img
                          className="avatar avatar-xs avatar-4x3"
                          src="src/assets/svg/illustrations/review-rating-shield.svg"
                          alt="Image Description"
                        />
                      </div>
                      <div className="flex-grow-1 text-truncate ms-3">
          ...
          <div className="dropdown">
            ...
            >
              <div className="avatar avatar-sm avatar-circle">
                <img
                  className="avatar-img"
                  src="src/assets/img/160x160/img6.jpg"
                  alt="Image Description"
                />
            ...
            >
              ...
              <div className="dropdown">
                ...
                >
                  <a className="dropdown-item" href="#">
                    <span className="legend-indicator bg-success me-1" />{" "}
                    Available
                  </a>
                  <a className="dropdown-item" href="#">
