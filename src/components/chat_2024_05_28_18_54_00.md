...
import '../assets/vendor/hs-header/dist/hs-header.css';
import '../assets/vendor/hs-mega-menu/dist/hs-mega-menu.css';

function Navbar() {
  console.log('Current Working Directory:', process.env.REACT_APP_CWD);

  useEffect(() => {
    const hsHeaderScript = document.createElement('script');
    hsHeaderScript.src = '../assets/vendor/hs-header/dist/hs-header.min.js';
    hsHeaderScript.onload = () => {
      new HSHeader('#header').init();
    };
    document.body.appendChild(hsHeaderScript);

    const hsMegaMenuScript = document.createElement('script');
    hsMegaMenuScript.src = '../assets/vendor/hs-mega-menu/dist/hs-mega-menu.min.js';
    hsMegaMenuScript.onload = () => {
      new HSMegaMenu('.js-mega-menu');
    };
    document.body.appendChild(hsMegaMenuScript);

    // Cleanup function to remove scripts when component unmounts
    return () => {
      document.body.removeChild(hsHeaderScript);
      document.body.removeChild(hsMegaMenuScript);
    };
  }, []);
    return (
    ...
    <div className="navbar-vertical-footer-offset">
      ...
      <a className="navbar-brand" href="../index.html" aria-label="Front">
        <img
          ...
          src="{% static 'assets/svg/logos/logo.svg' %}"
          alt="Logo"
          data-hs-theme-appearance="default"
        />
        <img
          className="navbar-brand-logo"
          src="{% static 'assets/svg/logos-light/logo.svg' %}"
          alt="Logo"
          data-hs-theme-appearance="dark"
        />
        <img
          className="navbar-brand-logo-mini"
          src="{% static 'assets/svg/logos/logo-short.svg' %}"
          alt="Logo"
          data-hs-theme-appearance="default"
        />
        <img
          className="navbar-brand-logo-mini"
          src="{% static 'assets/svg/logos-light/logo-short.svg' %}"
          alt="Logo"
          data-hs-theme-appearance="dark"
        />
      </a>
        ...
        >
          ...
          <div className="nav-item">
            ...
            >
              ...
              <a className="nav-link " href="../dashboard-alternative.html">
                Alternative
              </a>
            </div>
          </div>
          ...
          <div id="navbarVerticalMenuPagesMenu">
            ...
            <div className="nav-item">
              ...
              >
                ...
                <a className="nav-link " href="../user-profile-my-profile.html">
                  My Profile
                </a>
              </div>
            </div>
            ...
            <div className="nav-item">
              ...
              >
                ...
                <a className="nav-link " href="../account-invoice.html">
                  Invoice
                </a>
              </div>
            </div>
            ...
            <div className="nav-item">
              ...
              <div
                ...
                data-bs-parent="#navbarVerticalMenuPagesMenu"
              >
                <a className="nav-link " href="../ecommerce.html">
                  Overview
                </a>
                ...
                <a className="nav-link " href="../ecommerce-referrals.html">
                  Referrals
                </a>
                <a
                  className="nav-link "
            ...
            <div className="nav-item">
              ...
              >
                ...
                <a className="nav-link " href="../project-files.html">
                  Files
                </a>
                <a className="nav-link " href="../project-activity.html">
                  Activity
                </a>
                <a className="nav-link " href="../project-teams.html">
                  Teams
                </a>
                <a className="nav-link " href="../project-settings.html">
                  Settings
                </a>
              </div>
            </div>
                ...
                <div id="navbarVerticalMenuAuthenticationMenu">
                  ...
                  <div className="nav-item">
                    ...
                    >
                      <a
                        className="nav-link "
                        href="../authentication-2-step-verification-basic.html"
                      >
                        Basic
                      </a>
                      <a
                        className="nav-link "
                        href="../authentication-2-step-verification-cover.html"
                      >
                        Cover
                      </a>
                    </div>
                  ...
                  <a className="nav-link " href="../error-404.html">
                    Error 404
                  </a>
          ...
          <div className="nav-item">
            <a
              className="nav-link "
              href="../apps-invoice-generator.html"
              data-placement="left"
            >
          ...
          <div className="nav-item">
            <a
              className="nav-link "
              href="../documentation/typography.html"
              data-placement="left"
            >
            ...
            <div className="dropdown dropup">
              ...
              >
                ...
                >
                  ...
                  <span className="text-truncate" title="Auto (system default)">
                    Auto (system default)
                  </span>
                </a>
                <a
            ...
            <div className="dropdown dropup">
              ...
              >
                <img
                  ...
                  src="{% static 'assets/vendor/flag-icon-css/flags/1x1/us.svg' %}"
              ...
              >
                ...
                <a className="dropdown-item" href="#">
                  <img
                    className="avatar avatar-xss avatar-circle me-2"
                    src="{% static 'assets/vendor/flag-icon-css/flags/1x1/gb.svg' %}"
                    alt="Flag"
                  />
                  <span className="text-truncate" title="English">
                    English (UK)
                ...
                <a className="dropdown-item" href="#">
                  <img
                    className="avatar avatar-xss avatar-circle me-2"
                    src="{% static 'assets/vendor/flag-icon-css/flags/1x1/de.svg' %}"
                    alt="Flag"
                  />
                ...
                <a className="dropdown-item" href="#">
                  <img
                    className="avatar avatar-xss avatar-circle me-2"
                    src="{% static 'assets/vendor/flag-icon-css/flags/1x1/dk.svg' %}"
                    alt="Flag"
                  />
                ...
                <a className="dropdown-item" href="#">
                  <img
                    className="avatar avatar-xss avatar-circle me-2"
                    src="{% static 'assets/vendor/flag-icon-css/flags/1x1/it.svg' %}"
                    alt="Flag"
                  />
                ...
                <a className="dropdown-item" href="#">
                  <img
                    className="avatar avatar-xss avatar-circle me-2"
                    src="{% static 'assets/vendor/flag-icon-css/flags/1x1/cn.svg' %}"
                    alt="Flag"
                  />
